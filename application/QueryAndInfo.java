...
/**
 * This is the middle part of the GUI, containing the food query and the nutrient info
 */
public class QueryAndInfo {
    ...
    try {
      ...
      filterButton.setOnAction(new EventHandler<ActionEvent>() {
        public void handle(ActionEvent e) {
          ...
          if (text1.getText().equals("0") && text11.getText().equals("")
              && text2.getText().equals("0") && text21.getText().equals("")
              && text3.getText().equals("0") && text31.getText().equals("")
              && text4.getText().equals("0") && text41.getText().equals("")
              && text5.getText().equals("0") && text51.getText().equals("")) {
      ...
      innervBox.getChildren().addAll(hBox1, hBox2, hBox3, hBox4, hBox5, empty, textBox, textlong,
          hBoxlast);
      outerBox.getChildren().addAll(innerBox, innervBox);
      outerBox.setSpacing(5);
      innervBox.setStyle(
          "-fx-background-color: #8FAADC;" + "-fx-padding: 3;" + "-fx-border-color: #000000;"
      ...
      vbox1.setStyle("-fx-background-color: #8FAADC;" + "-fx-border-color: #000000;"
          + "-fx-border-width: 3;" + "-fx-border-style: solid inside;");
  ...
  /**
   * Helper method for finding the intersection of nutrientlist and namelist and return the
   * finallist
   * 
   * @param list1
   * @param list2
  ...
  /**
   * Helper method for comparing food item by name; if name are the same, compare by their ID
   */
